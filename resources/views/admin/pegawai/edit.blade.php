        ...
        <div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-gray-200 border-0">
            <div class="rounded-t bg-white mb-0 px-6 py-6">
                <div class="text-center flex justify-between">
                    <h6 class="text-gray-800 text-xl font-bold">Ubah Pegawai</h6>
                    <div>
            ...
            <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
                <form action="{{ url('/admin/pegawai/' . $pegawai->id) }}" method="post" accept-charset="UTF-8"
                      enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
                    <h6 class="text-gray-500 text-sm mt-3 mb-6 font-bold uppercase"> Pegawai </h6>
                    @include ('admin.pegawai.form', ['formMode' => 'edit'])
                </form>
            </div>
        </div>
    </div>
