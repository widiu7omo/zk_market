            ...
            <div
                ...
                <div class="rounded-t bg-white mb-0 px-6 py-6">
                    <div class="text-center flex justify-between">
                        <h6 class="text-gray-800 text-xl font-bold">Detail Pegawai #{{ $pegawai->id }} </h6>
                        <div>
                            <a href="{{ url('/admin/pegawai') }}" title="Back">
                                <button
                            ...
                            <a href="{{ url('/admin/pegawai/' . $pegawai->id . '/edit') }}" title="Edit Pegawai">
                                <button
                            ...
                            <form method="POST" action="{{ url('admin/pegawai' . '/' . $pegawai->id) }}"
                    ...
                    <div class="table-responsive">
                        <table class="rounded">
                            ...
                            <tr>
                                ...
                                <td class="font-bold px-2">{{ $pegawai->id }}</td>
                            </tr>
                            <tr>
                                <th class="px-5 w-5 align-middle py-3 text-sm uppercase whitespace-no-wrap font-semibold text-left bg-gray-100 text-gray-600 border-gray-200">
                                    Nama
                                </th>
                                <td class="font-bold px-2"> {{ $pegawai->nama }} </td>
                            </tr>
                            <tr>
                                <th class="px-5 w-5 align-middle py-3 text-sm uppercase whitespace-no-wrap font-semibold text-left bg-gray-100 text-gray-600 border-gray-200">
                                    Jenis Kelamin
                                </th>
                                <td class="font-bold px-2"> {{ $pegawai->jenis_kelamin }} </td>
                            </tr>
                            <tr>
                                <th class="px-5 w-5 align-middle py-3 text-sm uppercase whitespace-no-wrap font-semibold text-left bg-gray-100 text-gray-600 border-gray-200">
                                    Nohp
                                </th>
                                <td class="font-bold px-2"> {{ $pegawai->nohp }} </td>
                            </tr>
                            <tr>
                                <th class="px-5 w-5 align-middle py-3 text-sm uppercase whitespace-no-wrap font-semibold text-left bg-gray-100 text-gray-600 border-gray-200">
                                    Alamat
                                </th>
                                <td class="font-bold px-2"> {{ $pegawai->alamat }} </td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
