                ...
                <div
                        ...
                        <div class="flex flex-wrap items-center">
                            ...
                            <form method="POST" action="{{ url('admin/alamat' . '/' . $alamat->id) }}"
                                ...
                                <button type="submit"
                                        ...
                                        title="Delete Alamat" onclick="return confirmModal(this)"><i
                    ...
                    <div class="flex flex-wrap p-3 justify-start flex-row m-3">
                        <table class="table-responsive text-gray-900">
                            ...
                            <tr>
                                <th class="w-3/12 text-left border-r-2 font-bold tracking-wider uppercase"> Alamat Lengkap</th>
                                <td class="px-4 py-2 leading-snug"> {{ $alamat->alamat_lengkap }} </td>
                            </tr>
                            <tr>
                                <th class="w-3/12 text-left border-r-2 font-bold tracking-wider uppercase"> Rincian Alamat</th>
                                <td class="px-4 py-2 leading-snug"> {{ $alamat->rincian_alamat }} </td>
                            </tr>
                        </table>
                    </div>
                </div>
