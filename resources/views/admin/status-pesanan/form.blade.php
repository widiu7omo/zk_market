<div class="p-2 pt-0 w-full md:w-6/12">
    <label for="status_pesanan" class="tracking-wide uppercase text-sm font-bold text-white">{{ 'Status Pesanan' }}
        <input required type="text" id="status_pesanan" name="status_pesanan" placeholder="Input status_pesanan"
               value="{{ isset($statuspesanan->status_pesanan) ? $statuspesanan->status_pesanan : ''}}"
