                                ...
                                <tr>
                                    <td class="px-4 py-4 text-center whitespace-no-wrap">
                                        ...
                                        <div
                                            ...
                                            <a title="View StatusPesanan"
                                               class="text-sm py-2 px-4 font-normal block whitespace-no-wrap bg-transparent hover:bg-gray-300 m-2 rounded text-gray-800"
                                               href="{{ url('/admin/status-pesanan/' . $item->id) }}"><i
                                                    class="fas fa-info-circle"></i>&nbsp; View</a>
                                            <a title="Edit StatusPesanan"
                                               class="text-sm py-2 px-4 font-normal block whitespace-no-wrap bg-transparent hover:bg-gray-300 m-2 rounded text-gray-800"
                                               href="{{ url('/admin/status-pesanan/' . $item->id . '/edit') }}"><i
                                                    class="fas fa-pen"></i>&nbsp; Edit</a>
                                            <form method="POST"
                                                  action="{{ url('/admin/status-pesanan' . '/' . $item->id) }}"
                                    ...
                                    <td class="whitespace-no-wrap px-4 py-4 uppercase font-bold text-sm">{{ $item->status_pesanan }}</td>
                                </tr>
                            @empty
                                <tr>
