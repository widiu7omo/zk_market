...
@section('content')
    <div class="px-4 md:px-10 mx-auto w-full h-full -mt-24">
        <div class="flex flex-wrap mb-32">
            <div
                class="relative flex flex-col min-w-0 break-words h-full w-full xl:w-8/12 mb-6 shadow-lg rounded-lg bg-gray-100 xl:mx-auto">
                            ...
                            <div class="w-full px-4 mb-3">
                                <div
                                    ...
                                    <div class="flex-auto p-4">
                                        <div class="flex flex-wrap">
                                            <div class="relative w-full pr-4 max-w-full flex-grow flex-1"><h5
                                                    class="text-gray-500 uppercase font-bold text-xs">Bayar
                                                    ditempat</h5>
                                                <span
