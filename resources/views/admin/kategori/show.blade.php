<x-app-layout>
    ...
    @livewire('admin.components.navbar',['active'=>'Manajemen Kategori Produk'])
            ...
            <div
                ...
                <div class="rounded-t bg-white mb-0 px-6 py-6">
                    <div class="text-center flex justify-between">
                        <h6 class="text-gray-800 text-xl font-bold">Detail Kategori #{{ $kategori->id }}</h6>
                        <div>
                            ...
                            <a href="{{ url('/admin/kategori/' . $kategori->id . '/edit') }}" title="Edit Kategori">
                                <button
                    ...
                    <div class="table-responsive">
                        <table class="rounded">
                            ...
                            <tr>
                                ...
                                <td class="font-bold px-2">{{ $kategori->id }}</td>
                            </tr>
                            <tr>
                                <th class="px-5 w-5 align-middle py-3 text-sm uppercase whitespace-no-wrap font-semibold text-left bg-gray-100 text-gray-600 border-gray-200">
                                    Kategori
                                </th>
                                <td class="font-bold px-2"> {{ $kategori->kategori }} </td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
