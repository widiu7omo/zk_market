                ...
                <div
                        ...
                        <div class="flex flex-wrap items-center">
                            ...
                            <form method="POST" action="{{ url('admin/customer' . '/' . $customer->id) }}"
                                ...
                                <button type="submit"
                                        ...
                                        title="Delete Customer" onclick="return confirmModal(this)"><i
                    ...
                    <div class="flex flex-wrap p-3 justify-start flex-row m-3">
                        <table class="table-responsive text-gray-900">
                            ...
                            <tr>
                                <th class="w-3/12 border-r-2 font-bold tracking-wider uppercase"> Nama</th>
                                <td class="px-4 py-2 leading-snug"> {{ $customer->nama }} </td>
                            </tr>
                            <tr>
                                <th class="w-3/12 border-r-2 font-bold tracking-wider whitespace-no-wrap text-left uppercase"> No Hp</th>
                                <td class="px-4 py-2 leading-snug"> {{ $customer->no_hp }} </td>
                            </tr>
                        </table>
                    </div>
                </div>
