                        ...
                        <table class="table-responsive rounded-2xl w-full">
                            ...
                            @forelse($detailpesanan as $item)
                                <tr>
                                    ...
                                    <td class="whitespace-no-wrap px-4 py-4">{{ $item->pesanan_id }}</td>
                                    <td class="whitespace-no-wrap px-4 py-4">{{ $item->produk_id }}</td>
                                    <td class="whitespace-no-wrap px-4 py-4">{{ $item->jumlah }}</td>
                                </tr>
                            @empty
                                <tr>
