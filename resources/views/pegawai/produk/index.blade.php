                ...
                <div
                    ...
                    <div class="rounded-t mb-0 px-4 py-3 bg-transparent">
                        <div class="flex flex-wrap items-center">
                            ...
                            <div class="relative flex flex-wrap items-stretch lg:w-3/12 block mr-5">
                                ...
                                <form method="GET" action="{{ url('/pegawai/produk') }}" accept-charset="UTF-8"
                            ...
                            <a class="uppercase tracking-wide text-sm py-3 px-3 bg-brown-lighter hover:bg-brown-dark shadow-lg rounded-lg text-white font-bold"
                               href="{{ route('pegawai.produk.create') }}">Tambah Produk Baru</a>
                        </div>
                    </div>
                    <div class="m-4 flex-auto rounded-t-2xl rounded-2xl bg-gray-100 shadow overflow-x-scroll border-gray-700 sm:rounded-lg">
                        <table class="table-responsive rounded-2xl w-full">
                                    ...
                                    <td class="px-4 py-4 text-center whitespace-no-wrap">
                                        ...
                                        <div
                                            ...
                                            <a title="View Produk"
                                               ...
                                               href="{{ url('/pegawai/produk/' . $item->id) }}"><i
                                                    class="fas fa-info-circle"></i>&nbsp; View</a>
                                            <a title="Edit Produk"
                                               class="text-sm py-2 px-4 font-normal block whitespace-no-wrap bg-transparent hover:bg-gray-300 m-2 rounded text-gray-800"
                                               href="{{ url('/pegawai/produk/' . $item->id . '/edit') }}"><i
                                                    class="fas fa-pen"></i>&nbsp; Edit</a>
                                            <form method="POST" action="{{ url('/pegawai/produk' . '/' . $item->id) }}"
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="w-12 px-4 py-4 text-center">Data Kosong</td>
                                </tr>
                            @endforelse
                            </tbody>
                        </table>
