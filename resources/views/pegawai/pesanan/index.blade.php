                    ...
                    <div class="rounded-t mb-0 px-4 py-3 bg-transparent">
                        <div class="flex flex-wrap items-center">
                            ...
                            <div class="relative flex flex-wrap items-stretch lg:w-3/12 block mr-5">
                                ...
                                <form method="GET" action="{{ url('/pegawai/pesanan') }}" accept-charset="UTF-8"
                            ...
                            @if(strpos(request()->route()->getName() ,'customer') !== false)
                                <a class="uppercase tracking-wide text-sm py-3 px-3 bg-red-200 hover:bg-red-300 shadow rounded-lg text-red-500 font-bold"
                                   href="{{ url('/pegawai/customer') }}">Kembali</a>
                            @endif
                        </div>
                    </div>
                    <div
                                    ...
                                    <td class="px-4 py-4 text-center whitespace-no-wrap">
                                        ...
                                        <div
                                            ...
                                            <a title="View Pesanan"
                                               ...
                                               href="{{ url('/pegawai/pesanan/' . $item->id) }}"><i
                                                    class="fas fa-info-circle"></i>&nbsp; Detail Pesanan</a>
                                            <a title="Edit Pesanan"
                                               class="text-sm py-2 px-4 font-normal block whitespace-no-wrap bg-transparent hover:bg-gray-300 m-2 rounded text-gray-800"
                                               href="{{ url('/pegawai/pesanan/' . $item->id . '/edit') }}"><i
                                                    class="fas fa-pen"></i>&nbsp; Edit</a>
                                            <div class="h-0 my-2 border border-solid border-gray-200"></div>
                                            <form method="POST"
                                                  action="{{ url('/pegawai/pesanan/' . $item->id) }}"
                                            ...
                                            <form method="POST"
                                                ...
                                                <button type="submit"
                                                        class="text-sm py-2 px-4 font-normal block whitespace-no-wrap bg-transparent hover:bg-gray-300 m-2 rounded text-gray-800"
                                                        title="Proses Pengataran"
                                                        onclick="return confirmModal(this,'Konfirmasi','Apakah anda yakin ingin melakukan proses pengantaran ?','Antar Dong :D')">
                                                    <i
                                                        class="fas fa-shipping-fast"></i>&nbsp; Proses Pengantaran
                                                </button>
                                            </form>
                                            <form method="POST"
                                                  action="{{ url('/pegawai/pesanan/' . $item->id) }}"
                                            ...
                                            <form method="POST"
                                                ...
                                                <button type="submit"
                                                    ...
                                                    <i
                                                        class="fas fa-trash"></i>&nbsp; Pesanan Batal
                                                </button>
                                            </form>
                                        </div>
                                    </td>
