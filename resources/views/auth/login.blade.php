<x-guest-layout>
    <div class="min-h-screen flex flex-col justify-center items-center pt-6 px-4 sm:pt-0 bg-gray-100 p-8">
        ...
        <div style="background-color: #B09685"
            ...
            <div class="relative h-full flex flex-col min-w-0 break-words mb-6 rounded-lg border-0">
                <div class="flex-auto px-6 pt-0">
                    ...
                    <form action="{{route('login')}}" method="post">
                        ...
                        <div class="text-center mt-6 flex-no-wrap flex">
                            <button
                                class="bg-gray-500 text-white active:bg-gray-700 text-sm font-bold uppercase px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 w-1/2 ease-linear transition-all duration-150"
                                type="submit">
                                Masuk
                            </button>
                            <a href="{{ url('auth/google') }}"
                               class="w-1/2 bg-white justify-center active:bg-gray-100 text-gray-800 font-normal px-4 py-2 rounded outline-none focus:outline-none mr-1 mb-1 uppercase shadow hover:shadow-md inline-flex items-center font-bold text-xs ease-linear transition-all duration-150"
                               type="button">
            ...
            @if ($errors->any())
                <ul class="bg-red-100 p-2 mx-3 rounded-md">
