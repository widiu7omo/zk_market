<nav
    ...
    <div class="w-full mx-auto items-center flex justify-between md:flex-no-wrap flex-wrap md:px-10 pl-6 pr-4 py-4">
        <a class="text-white text-sm uppercase hidden lg:inline-block font-semibold"
           href="{{url('/')}}">{{$active??'NULL'}}</a>
                ...
                <div class="items-center flex">
                    <span
                        class="w-12 h-12 text-sm text-white bg-gray-300 inline-flex items-center justify-center rounded-full"><img
                            ...
                            src="{{Auth::user()->avatar ?? "https://ui-avatars.com/api/?background=random"}}"/></span>
                </div>
            </a>
